...
function mobilePhoneCheck(str){
	var flag = false;
	var unicom = [130, 131, 132, 145, 155, 156, 185, 186, 176];
	var cmcc = [134, 135, 136, 137, 138, 139, 147, 150, 151, 152, 157, 158, 159, 178, 182, 183, 184, 187, 188];
	var telecom = [133, 153, 189, 180, 181, 177];
