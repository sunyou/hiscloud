...
$(document).unbind(".combo").bind("mousedown.combo",tapBlurFunc);
if(parent!==window)
$(window).unbind("blur.combo").bind("blur.combo",tapBlurFunc);
_1b.unbind(".combo");
_1c.unbind(".combo");
_1d.unbind(".combo");
_1e.unbind(".combo");
if(!_1a.disabled){
var _1amoz=$.browser&&$.browser.mozilla;
if(_1amoz){
_1d.bind("input",function(){
if(_1a.editable){
if(_19.timer){
...
if(_48.multiple && !$.isArray(_47)){
_47=_47.split(_48.separator);
}
