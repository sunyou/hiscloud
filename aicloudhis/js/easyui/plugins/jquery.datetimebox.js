...
_9(_2,_4.value);
if(_4.currentAction){
var _43=$(_2).datebox("panel").children("div.datebox-button").find(".datebox-current");
_43.click(function(){var e=new Date;_3.spinner.timespinner("setValue",e.getHours()+_4.timeSeparator+e.getMinutes()+_4.timeSeparator+e.getSeconds()),_f(_2)})
}
};
function _a(_b){
...
$.fn.datetimebox.defaults=$.extend({},$.fn.datebox.defaults,{currentAction:false,showSeconds:true,timeSeparator:":",keyHandler:{up:function(){
},down:function(){
},enter:function(){
_f(this);
},query:function(q){
