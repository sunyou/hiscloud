...
if(col.width){
if(/%/.test(col.width)){
var numW=col.width.replace(/%/g,'')/100;
var w=Math.floor($('.datagrid').width()*numW);
_5a._outerWidth(w);
...
if(isNaN(col.boxWidth) || undefined === col.boxWidth) {
col.auto = true;
}
}else{
col.auto=true;
...
var _af=_ae.options;
var dc=_ae.dc;
if(!_ad || !_ad.rows) _ad={"total": 0, "rows": []};
...
var disableFields = $.data(tr[0], "editor.disable.fields") || [];
if(-1===_2(disableFields, _11e)&&col&&col.editor){
var _11f,_120;
...
easyloader.load(_11f=='text'? 'validatebox':_11f);
...
}},combogrid:{init:function(_19a,_19b){
var _19c=$("<input type=\"text\">").appendTo(_19a);
_19c.combogrid(_19b);
return _19c;
},destroy:function(_19d){
$(_19d).combogrid("destroy");
},getValue:function(_19e){
return $(_19e).combogrid("getValue");
},setValue:function(_19f,_1a0){
$(_19f).combogrid("setValue",_1a0);
},resize:function(_1a1,_1a2){
$(_1a1).combogrid("resize",_1a2);
...
},enableEditor: function(jq, options) {
var rowIndex = options.index || 0;
var field = options.field || undefined;
jq.each(function(){
var opts = $.data(this, "datagrid").options;
...
$.each(field, function(){
_4(disableFields, this);
});
$.data(tr[0], "editor.disable.fields", disableFields);
} else {
$.data(tr[0], "editor.disable.fields", []);
}
});
},disableEditor: function(jq, options) {
var rowIndex = options.index || 0;
var field = options.field || undefined;
jq.each(function(){
var opts = $.data(this, "datagrid").options;
var tr = opts.finder.getTr(this, rowIndex);
if(undefined !== field) {
$.data(tr[0], "editor.disable.fields", $.isArray(field)? field:[field]);
} else {
var disableFields = []
tr.children("td").each(function() {
var disField = $(this).attr('field');
if(disField && -1 === _2(disableFields, disField)) {
disableFields.push(disField);
}
});
$.data(tr[0], "editor.disable.fields", disableFields);
}
...
$(_1cb).html(_1cf.join(""));
$.fn.sparkline && $(_1cb).find('.sparklineInDataGrid').sparkline('html', {
...
$CommonUI.getSparkLine();
var optSparkline=col.sparkline,tagOpt={},tagOptionsPrefix='spark',plugOptStr='';
$.each(optSparkline, function(si,so){
if(si)
if(si!=='enableTagOptions' || si!=='tagOptionsPrefix') {
plugOptStr+=' '+(tagOptionsPrefix + si.charAt(0).toLocaleUpperCase() + si.slice(1))+'='+'"'+so+ '"';
}
});
cc.push("<span class=\"sparklineInDataGrid\" values=\""+ (_1df!=undefined?_1df:"") +"\"" + plugOptStr + "></span>");
}else{
if(col.formatter){
...
}}).done(ajaxExceptionHandler).done(_204);
