...
if(_4.currentAction){_3.calendar.calendar('options').onSelect.call(_2,new Date());}
});
...
_a(this,q);
}},currentText:"Today",currentAction:false,closeText:"Close",okText:"Ok",formatter:function(_1d){
