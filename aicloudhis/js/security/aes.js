...
var ContextPath_UseForAes=getContextPath();
...
document.writeln('<script src="'+ContextPath_UseForAes+'/js/security/CryptoJS/components/core-min.js"></script>');
document.writeln('<script src="'+ContextPath_UseForAes+'/js/security/CryptoJS/components/cipher-core-min.js"></script>');
document.writeln('<script src="'+ContextPath_UseForAes+'/js/security/CryptoJS/components/pad-zeropadding-min.js"></script>');
document.writeln('<script src="'+ContextPath_UseForAes+'/js/security/CryptoJS/components/aes-min.js"></script>');
document.writeln('<script src="'+ContextPath_UseForAes+'/js/security/CryptoJS/components/md5-min.js"></script>');
document.writeln('<script src="'+ContextPath_UseForAes+'/js/security/CryptoJS/components/enc-base64-min.js"></script>');
document.writeln('<script src="'+ContextPath_UseForAes+'/js/security/JSON-js/json2.js"></script>');
